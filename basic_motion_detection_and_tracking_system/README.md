...
<p align="center"><b>First frame</b> background model: click on the image for
the full video</p>
<br/>
<br/>
<p align="center">
...
<p align="center"><b>Weighted average</b> background model: click on the image
...
<p align="center"><b>Frame delta</b> image:</p>
<br/>
<p id="thresh_sample_image" align="center"><img src="./samples/thresh_000117.jpeg"/></p>
<p align="center"><b>Thresholded</b> image:</p>
<br/>
...
* [How to make a splitscreen movie on Mac with iMovie and OpenShot](test "TODO: add URL")
* [Generate a movie from a sequence of images on a Mac](test "TODO: add URL")
...
[Script usage](#script-usage) for more details how script usage.
...
bounding boxes around the detected moving objects. [Security feed sample image](#security_feed_sample_image)
